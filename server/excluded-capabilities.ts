...
export const excludedCapabilities: ExcludedCapabilityInfo[] = [
	{
		...
		affectedSurface: "Related event-node and input-action helpers are excluded from the MCP surface.",
		reason:
	...
	},
	{
		...
		affectedSurface: "Graph-analysis, graph-inspection, and node-search helpers are excluded from the MCP surface.",
		reason:
	...
	},
	{
		...
		reason: "The current UE4.25 Python environment does not expose reliable function-call node reference setup.",
	},
	{
		capability: "Blueprint variable and function metadata inspection",
		affectedSurface: "Variable-detail and function-detail helpers are excluded from the MCP surface.",
		reason:
	...
	},
	{
		...
		affectedSurface: "Variable-creation helpers are excluded from the MCP surface.",
		reason: "BPVariableDescription and EdGraphPinType are not exposed in the current UE4.25 Python environment.",
	},
	{
		capability: "UMG delegate-binding authoring",
		affectedSurface: "Widget event-binding and text-binding helpers are excluded from the MCP surface.",
		reason: "DelegateEditorBinding is not exposed in the current UE4.25 Python environment.",
	},
]
